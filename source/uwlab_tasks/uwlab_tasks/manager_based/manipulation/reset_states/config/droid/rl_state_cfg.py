...
class CommandsCfg:
    ...
    task_command = task_mdp.TaskCommandCfg(
        ...
        success_position_threshold=0.05,
        success_orientation_threshold=7.0,
...
variants = {
    "scene.insertive_object": {
        ...
        "banana": make_insertive_object(f"./envs/assets/banana/banana.usd"),
        # "banana": make_insertive_object(f"{ARHANJAIN_CLOUD_ASSETS_DIR}/envs/assets/banana/banana.usd"),
    },
    "scene.receptive_object": {
        ...
        # "plate": make_receptive_object(f"{ARHANJAIN_CLOUD_ASSETS_DIR}/envs/assets/plate/plate.usd"),
    },
}
